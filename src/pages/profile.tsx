          ...
          <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <VStack>
              ...
              <div className="mt-1 mb-5">
                <MdVerifiedUser color="yellowgreen" size={"36"} />
              </div>
            </VStack>
            <hr />
          </div>
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        type="textfield"
                        required
                        className="pl-2 block w-full rounded-md border-0 py-12 text-white-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-white-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 text-field"
                      />
                    </div>
                  </div>
